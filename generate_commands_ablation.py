                ...
                for sub_exp in sub_exps:
                    ...
                    if algorithm_name not in existing_exp:
                        existing_exp[algorithm_name] \
                            ...
                            'ablation': config['lora'].get('ablation', ''),
                            }]
                    else:
...
for ablation_type in ablation:
    per_exp_config['ablation']=ablation_type
    for data in datasets:
                        ...
                        for warmup_round in settings.get('warmup_round', [100]):
                            ...
                            for seed in seeds:
                                ...
                                cmd = (
                                    ...
                                    f"lora.ablation {ablation_type}"
                                )
                                commands.append(cmd)

# Write to file
output_file = "experiments_ablation.txt"
